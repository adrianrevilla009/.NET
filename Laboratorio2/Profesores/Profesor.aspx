...
<body>
    ...
    <div style="height: 335px; margin-top: 35px; width: 172px;">
        ...
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Profesores/TareasProfesor.aspx">Tareas</asp:HyperLink>
        <br />
        <br />
        <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/Profesores/ImportarExportar/ImportarTareas.aspx">Importar y XML Document</asp:HyperLink>
        <br />
        <br />
    ...
    <div style="height: 176px; margin-top: 0px; width: 700px; margin-left: 256px;">
        ...
        <br />
        <h1 style="margin-left: 280px; width: 420px;">Profesores</h1>
